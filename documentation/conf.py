...
# -*- coding: utf-8 -*-
#
# addwiki documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'documentation.tex', 'Documentation',
     'Network and Service Management Optimization Framework', 'manual'),
]
...
man_pages = [
    (master_doc, 'documentation', 'Network and Service Management Optimization Framework for Java',
     [author], 1)
]
